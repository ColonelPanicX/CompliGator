...
KNOWN_URLS: list[tuple[str, str]] = [
    ...
    (
        "internal",
        "https://dodcio.defense.gov/Portals/0/Documents/CMMC/CMMC-AlignmentNIST-Standards.pdf",
    ),
    ("internal", "https://dodcio.defense.gov/Portals/0/Documents/CMMC/CMMC-SPRS.pdf"),
    (
        "internal",
        "https://dodcio.defense.gov/Portals/0/Documents/CMMC/CMMC-eMASS.pdf?ver=l-hPeQGKDLRXdQrpxM2AQg%3d%3d",
    ),
    (
        "internal",
    ...
    (
        "internal",
        "https://dodcio.defense.gov/Portals/0/Documents/CMMC/CMMC-LevelsDeterminationBrief_v2.pdf",
    ),
    (
        "internal",
